...
public class S2CConfigKeepAlive extends S2CConfigKeepAlivePacket implements S2CAbstractKeepAlive {
    public S2CConfigKeepAlive() {
    }

    public S2CConfigKeepAlive(final long id) {
        super(id);
    }
