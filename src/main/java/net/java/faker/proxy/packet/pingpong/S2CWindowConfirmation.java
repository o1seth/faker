...
public class S2CWindowConfirmation implements S2CAbstractPing {
    public int windowId;
    public short uid;
    ...
    public boolean equals(Object o) {
        ...
        S2CWindowConfirmation that = (S2CWindowConfirmation) o;
    ...
    public String toString() {
        return "S2CWindowConfirmation " + windowId + ": " + uid + ", " + accepted;
    }
}