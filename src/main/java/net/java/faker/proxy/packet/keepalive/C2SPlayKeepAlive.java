...
public class C2SPlayKeepAlive extends C2SPlayKeepAlivePacket implements C2SAbstractKeepAlive {
    public C2SPlayKeepAlive() {
    }

    public C2SPlayKeepAlive(final long id) {
        super(id);
    }
